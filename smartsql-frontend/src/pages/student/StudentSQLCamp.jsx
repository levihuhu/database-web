...
import { Typography, Card, Row, Col, Menu, Badge, Progress, Tabs } from 'antd';
import { 
  DatabaseOutlined, 
  TableOutlined, 
  FilterOutlined, 
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <Tabs defaultActiveKey="1">
        {/* <TabPane tab="Learning Modules" key="1">
          <Row gutter={[16, 16]}>
            <Col span={6}>
        ...
        <TabPane tab="Dynamic SQL Query" key="2" icon={<CodeOutlined />}>
          <DynamicSQLQuery />
        </TabPane>
      </Tabs>
    </div>

            ...
            <Col xs={24} sm={12} md={8} key={exercise.exercise_id}>
              <Card
                ...
                style={{
                  ...
                  height: '100%',
                  minHeight: '100px',
                  border: exercise.completed ? '4px solid #52c41a' : '4px solid rgb(178, 180, 195))',
                }}
                ...
                <Card.Meta
                  ...
                  title={
                    <div style={{ flexShrink: 0, marginBottom: 2 }}>
                      <Paragraph ellipsis={{ rows: 2, tooltip: exercise.title }} style={{ fontWeight: 'bold', minHeight: '20px' }}>
                        {exercise.title}
                      </Paragraph>
                    </div>
                  }
